...
/**
 * @implNote TP5 implementation
 */
public class ArnTest extends ATest<String> {
	...
	private ArnTest(int taskToHandle){
	...
	private class Task {
		...
		void exec(){
			try {
				...
				log(this.taskName + " executed in " + this.executionTime);
